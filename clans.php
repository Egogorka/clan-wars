...
<?php
    ...
    $UserInfo = GetRowByID($_SESSION['id'] ?? NULL     , 'users');
    $ClanInfo = GetRowByID($UserInfo['clan_id'] ?? NULL, 'clans');
?>
...
<div id="container">
    ...
    <?php
    require_once 'lib/clans/clanlog/join.php';
    ...
    while($row = $db->fetch($stmt)){
        ...
        //$lStmt = $pd->prepare($sql);
        //$lStmt->execute([$row['leader_id']]);

        //$leader = $lStmt->fetch(PDO::FETCH_LAZY);
